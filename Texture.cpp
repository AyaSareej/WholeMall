...
Texture::Texture(const std::string& image, const std::string& texType, GLuint slot, const std::string& texPath)
{
    path = texPath;
    type = texType;
    ...
    if (numColCh == 4)
        ...
        throw std::invalid_argument("Texture type not recognized");
